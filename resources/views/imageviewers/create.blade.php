...
<form action="{{ route('imageviewers.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="small text-muted mt-2">Upload your picture. Max file size 50 MB</div>
                   ...
                   <label> Department&nbsp; &nbsp; </label>
                    ...
                    <div class="form-group">
                                ...
                                <input type="text"  value="{{{ $imageviewer->taggingcpu ?? '' }}}" class="form-control"  name="purchaseOrder"/>
                            </div>
                            <div class="form-group">
                                <label for="title">Tagging No(Monitor):</label>
                                <input type="text" value="{{ $imageviewer->taggingmonitor ?? '' }}" class="form-control"  name="deliveryOrder"/>
                            </div>
                    ...
                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  value="{{{ $imageviewer->invoiceNo ?? '' }}}" class="form-control"  name="invoiceNo"/>
                            </div>
                            <div class="form-group">
                                <label for="description">Supplier:</label>
                                <input type="text"  value="{{{ $imageviewer->supplier ?? '' }}}" class="form-control"  name="supplier"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file"  value="{{{ $imageviewer->folder ?? '' }}}" class="form-control"  name="folder[]" multiple/>
                            </div>
