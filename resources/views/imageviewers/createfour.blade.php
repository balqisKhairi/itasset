...
<div class="card-body">
<form action="{{ route('imageviewers.storefour') }}" method="POST">
    @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  value="{{{ $imageviewer->msOfficeAndVersion ?? '' }}}" class="form-control"  name="msOfficeAndVersion"/>
                            </div>
                            <div class="form-group">
                  ...
                  <div class="card-footer">
                    ...
                    <div class="col-md-6 text-left">
                                <a href="{{ route('imageviewers.createthree') }}" class="btn btn-danger pull-right">Previous</a>
                            </div>
