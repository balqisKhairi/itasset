...
<form action="{{ route('biometrics.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
                   ...
                   <label> Department&nbsp; &nbsp; </label>
                    ...
                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  value="{{{ $biometric->supplier ?? '' }}}" class="form-control"  name="supplier"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file"  value="{{{ $biometric->folder ?? '' }}}" class="form-control"  name="folder[]" multiple/>
                            </div>
