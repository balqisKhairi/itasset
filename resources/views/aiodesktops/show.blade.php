    ...
    <div class="row">
        <div class="col-xl-4">
            ...
            <h4 class="card-header" align="center" >Details</h4>
                <div class="card-body text-center">
                    ...
                    <img class="img img-responsive"  width='400' height='250' src="{{ asset($aiodesktop->image) }}" alt=""/>
        ...
        <div class="col-xl-8">
            ...
            <div class="card-body">
                ...
                <td>
                <a href ="{{ route('aiodesktops.viewFolder',$aiodesktop->id) }}" >{{ $aiodesktop->purchaseOrder }} </a>    
                </td>
                </tr>
                ...
                <td>
                <a href ="{{ route('aiodesktops.viewFolder',$aiodesktop->id) }}">{{ $aiodesktop->deliveryOrder }}</a>    
                </td>
                </tr>
                ...
                <td>
                <a href ="{{ route('aiodesktops.viewFolder',$aiodesktop->id) }}">{{ $aiodesktop->invoiceNo }}</a>    
