...
<form action="{{ route('osdesktops.update',$osdesktop->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div class="form-group avatar">
                                <figure class="figure col-md-2 col-sm-3 col-xs-12">
                                    <img class="img-rounded img-responsive" id="output" height="100%" width="100%" style="width:100%;" src="{{ asset($osdesktop->image) }}" alt="">
                                </figure>
            ...
            <input class="form-control "  id="image" name="image" value="{{$osdesktop->image}}" src="{{ asset($osdesktop->image) }}"type="file" onchange="loadFile(event)"/>
            <div class="small text-muted mt-2">Upload your picture. Max file size 50 MB</div>

           

                                <label for="title">Assigned To:</label>
                                <input type="text" value="{{ $osdesktop->assignedTo }}" class="form-control"  name="assignedTo" placeholder="NAME">
                            </div>
                      
                            <div class="form-group">
                                <label for="description">Device Hostname:</label>
                                <input type="text"  value="{{{ $osdesktop->deviceHostname }}}" class="form-control"  name="deviceHostname"/>
                            </div>
                    ...
                    <div class="form-group">
                                ...
                                <input type="text"  value="{{{ $osdesktop->deviceIPaddress }}}" class="form-control"  name="deviceIPaddress" placeholder="Ex: 10.31.0.0"/>
                            </div>
                            <div class="form-group">
                                <label for="title">Device Manufacturer:</label>
                                <input type="text" value="{{ $osdesktop->deviceManufacturer }}" class="form-control"  name="deviceManufacturer">
                            </div>
                            <div class="form-group">
                                <label for="description">Device Model:</label>
                                <input type="text"  value="{{{ $osdesktop->deviceModel }}}" class="form-control"  name="deviceModel"/>
                            </div>
                            <div class="form-group">
                                <label for="description">Device Seriel Number:</label>
                                <input type="text"  value="{{{ $osdesktop->deviceSerielNumber }}}" class="form-control"  name="deviceSerielNumber"/>
                            </div>
                            <div class="form-group">
                                <label for="description">Warranty Date:</label>
                                <input type="date"  value="{{{ $osdesktop->warrantyDate }}}" class="form-control"  name="warrantyDate"/>
                            </div>
                    ...
                    <div class="form-group">
                                ...
                                <input type="text"  value="{{{ $osdesktop->monitorModel }}}" class="form-control"  name="monitorModel" placeholder="Ex: V194"/>
                            </div>
                            <div class="form-group">
                                <label for="title">Monitor Manufacturer:</label>
                                <input type="text" value="{{ $osdesktop->monitorManufacturer }}" class="form-control"  name="monitorManufacturer">
                            </div>
                            <div class="form-group">
                                <label for="description">Monitor Size:</label>
                                <input type="text"  value="{{{ $osdesktop->monitorSize }}}" class="form-control"  name="monitorSize"/>
                            </div>
                            <div class="form-group">
                                <label for="description">Monitor Seriel Number:</label>
                                <input type="text"  value="{{{ $osdesktop->monitorSerielNumber }}}" class="form-control"  name="monitorSerielNumber"/>
                            </div>
                   ...
                   <label> Department&nbsp; &nbsp; </label>
                    ...
                    <option value="{{$cat->id}}" {{$osdesktop->department_id == $cat->id  ? 'selected' : ''}}>{{$cat->departName}}</option>
                    @endforeach
                 </select>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $osdesktop->deviceLocation }}" class="form-control"  name="deviceLocation">
                            </div>
                    ...
                    <div class="form-group">
                                ...
                                <input type="text"  value="{{{ $osdesktop->operatingSystem }}}" class="form-control"  name="operatingSystem"/>
                            </div>
                            <div class="form-group">
                                <label for="title">Window Version:</label>
                                <input type="text" value="{{ $osdesktop->windowVersion }}" class="form-control"  name="windowVersion"/>
                            </div>
                            <div class="form-group">
                                <label for="description">Microsoft Office And Version:</label>
                                <input type="text"  value="{{{ $osdesktop->msOfficeAndVersion }}}" class="form-control"  name="msOfficeAndVersion" placeholder="Ex:Ms Office Pro Plus 2013"/>
                            </div>
                            <div class="form-group">
                                <label for="description">Office Seriel Key:</label>
                                <input type="text"  value="{{{ $osdesktop->officeSerielKey }}}" class="form-control"  name="officeSerielKey"/>
                            </div>
                            <div class="form-group">
                                <label for="description">Antivirus And Version:</label>
                                <input type="text"  value="{{{ $osdesktop->antivirusAndVersion }}}" class="form-control"  name="antivirusAndVersion"/>
                            </div>
                    ...
                    <div class="form-group">
                                ...
                                <input type="text"  value="{{{ $osdesktop->taggingcpu }}}" class="form-control"  name="purchaseOrder"/>
                            </div>
                            <div class="form-group">
                                <label for="title">Tagging No(Monitor):</label>
                                <input type="text" value="{{ $osdesktop->taggingmonitor }}" class="form-control"  name="deliveryOrder"/>
                            </div>

                    <div class="form-group">
                                <label for="description">Purchase Order(PO):</label>
                                <input type="text"  value="{{{ $osdesktop->purchaseOrder }}}" class="form-control"  name="purchaseOrder"/>
                            </div>
                            <div class="form-group">
                                <label for="title">Delivery Oder(DO):</label>
                                <input type="text" value="{{ $osdesktop->deliveryOrder }}" class="form-control"  name="deliveryOrder"/>
                            </div>
                            <div class="form-group">
                                <label for="description">Invoice No:</label>
                                <input type="text"  value="{{{ $osdesktop->noInvoice }}}" class="form-control"  name="noInvoice"/>
                            </div>
                            <div class="form-group">
                   <label> Supplier&nbsp; &nbsp; </label>
                    ...
                    <option value="{{$cat->id}}" {{$osdesktop->vendor_id == $cat->id  ? 'selected' : ''}}>{{$cat->companyName}}</option>
                     @endforeach
                    </select>
                    </div>
                            <div class="form-group">
                                <label for="description">Price Per Unit(RM):</label>
                                <input type="text"  value="{{{ $osdesktop->pricePerUnit }}}" class="form-control"  name="pricePerUnit" placeholder="RM 000.00"/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <option value=""> --SELECT--</option>
                                <option value="IT Asset" {{ $osdesktop->statusAsset == "IT Asset" ? 'selected' : '' }} >IT Asset</option>
                                <option value="Vendor" {{ $osdesktop->statusAsset == "Vendor" ? 'selected' : '' }} > Vendor</option>
                                <option value="Biomedical Engineering" {{ $osdesktop->statusAsset == "Biomedical Engineering" ? 'selected' : '' }}> Biomedical Engineering</option>
                                <option value="Lablink" {{ $osdesktop->statusAsset == "Lablink" ? 'selected' : '' }}> Lablink</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file"  value="{{ asset($osdesktop->folder) }}" class="form-control"  name="folder[]" multiple/>
                            </div>
