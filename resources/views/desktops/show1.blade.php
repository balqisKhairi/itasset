        ...
        <div class="col-xl-4">
            ...
            <h4 class="card-header" align="center" >Details</h4>
                <div class="card-body text-center">
                    ...
                    <img class="img img-responsive"  width='400' height='250' src="{{ asset($desktop->image) }}" alt=""/>
        ...
        <div class="col-xl-8">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <div class="card-body">
                   <!--<div class="row">
                  <div class="bio-row">
                      <p><span>IP Address </span>: {{ $desktop->deviceIPaddress }}</p>
                  </div>
                  <div class="bio-row">
                      <p><span>Manufacturer </span>: {{ $desktop->deviceManufacturer }}</p>
                  </div>
                  
                  <div class="bio-row">
                      <p><span>Model </span>: {{ $desktop->deviceModel }}</p>
                  </div>
                  <div class="bio-row">
                      <p><span>Warranty Date </span>: {{ $desktop->warrantyDate }}</p>
                  </div>
                </div>
                </div>-->
