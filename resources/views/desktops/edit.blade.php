    ...
    @method('PUT')
            ...
            <div class="small text-muted mt-2">Upload your picture. Max file size 50 MB</div>
                   ...
                   <label> Department&nbsp; &nbsp; </label>
                    ...
                    <option value="{{$cat->id}}" {{$desktop->department_id == $cat->id  ? 'selected' : ''}}>{{$cat->departName}}</option>
                    @endforeach
                    </select>
                    </div>
                    ...
                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $desktop->deliveryOrder }}" class="form-control"  name="deliveryOrder"/>
                            </div>
                            <div class="form-group">
                            ...
                            <label> Supplier&nbsp; &nbsp; </label>
                                ...
                                <option value="{{$cat->id}}" {{$desktop->vendor_id == $cat->id  ? 'selected' : ''}}>{{$cat->companyName}}</option>
                                @endforeach
                                </select>
                                </div>
