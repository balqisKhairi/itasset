...
b, h6 {
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div>
                <h2>List of imageviewers</h2>
            </div>
            <div>
                <a class="btn btn-success" href="{{ route('imageviewers.create') }}"> Add New imageviewer</a>

                @can('create', App\imageviewer::class)
            ...
            <form action="{{ url('importimageviewer') }}" class="form-container" method="post" enctype="multipart/form-data">
                @csrf
       ...
       <tbody id="myTable">
        <tr >
            ...
            <form action="{{ route('imageviewers.destroy',$s->id) }}" method="POST">
                    ...
                    <a class="btn btn-info" href="{{ route('imageviewers.show',$s->id) }}">View Full Details</a>
