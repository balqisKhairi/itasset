    ...
    @method('PUT')
            ...
            <div class="small text-muted mt-2">Upload your picture. Max file size 50 MB</div>
                   ...
                   <label> Department&nbsp; &nbsp; </label>
                    ...
                    <option value="{{$cat->id}}" {{$printer->department_id == $cat->id  ? 'selected' : ''}}>{{$cat->departName}}</option>
                    @endforeach
                    </select>
                    </div>
                   ...
                   <label> Supplier&nbsp; &nbsp; </label>
                    ...
                    <option value="{{$cat->id}}" {{$printer->vendor_id == $cat->id  ? 'selected' : ''}}>{{$cat->companyName}}</option>
                     @endforeach
                    </select>
                    </div>
                            <div class="form-group">
