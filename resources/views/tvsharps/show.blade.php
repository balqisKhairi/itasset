    ...
    <div class="row">
        <div class="col-xl-4">
            ...
            <h4 class="card-header" align="center" >Details</h4>
                <div class="card-body text-center">
                    ...
                    <img class="img img-responsive"  width='400' height='250' src="{{ asset($tvsharp->image) }}" alt=""/>
        ...
        <div class="col-xl-8">
            ...
            <div class="card-body">
                ...
                <td>
                <a href ="{{ route('tvsharps.viewFolder',$tvsharp->id) }}">{{ $tvsharp->purchaseOrder }}</a>    
                </td>
                </tr>
                ...
                <td>
                <a href ="{{ route('tvsharps.viewFolder',$tvsharp->id) }}">{{ $tvsharp->deliveryOrder }}</a>    
                </td>
                </tr>
                ...
                <td>
                <a href ="{{ route('tvsharps.viewFolder',$tvsharp->id) }}">{{ $tvsharp->noInvoice }}</a>    
