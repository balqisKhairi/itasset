    ...
    <div class="row">
        <div class="col-xl-4">
            ...
            <h4 class="card-header" align="center" >Details</h4>
                <div class="card-body text-center">
                    ...
                    <img class="img img-responsive"  width='400' height='250' src="{{ asset($laptop->image) }}" alt=""/>
        ...
        <div class="col-xl-8">
            ...
            <div class="card-body">
                ...
                <td>
                <a href ="{{ route('laptops.viewFolder',$laptop->id) }}" >{{ $laptop->purchaseOrder }} </a>    
                </td>
                </tr>
                ...
                <td>
                <a href ="{{ route('laptops.viewFolder',$laptop->id) }}">{{ $laptop->deliveryOrder }}</a>    
                </td>
                </tr>
                ...
                <td>
                <a href ="{{ route('laptops.viewFolder',$laptop->id) }}">{{ $laptop->invoiceNo }}</a>    
