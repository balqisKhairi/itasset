...
.btn-success1 {
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div>
                <a class="btn btn-success" href="{{ route('laptops.create') }}"> Add New Laptop</a>
            ...
            <form action="{{ url('importLaptop') }}" class="form-container" method="post" enctype="multipart/form-data">
                @csrf
            ...
            <a class="btn btn-primary" href="{{ route('laptops.exportLaptop') }}"> Export to Excel</a>
            </div>
                <br></br>
    ...
    @foreach(Session::get('excel_error') as $failure)
        <div class="alert alert-danger">
            <p>{{ $failure->errors()[0] }} 5 is for row Seriel number at line {{ $failure->row()}} from your Excel.</p>
        </div>
        @endforeach
    @endif
      ...
      <th scope="row">ID</th>
       ...
       <tr>
            ...
            <form action="{{ route('laptops.destroy',$s->id) }}" method="POST">
                    ...
                    <a class="btn btn-info" href="{{ route('laptops.show',$s->id) }}">View Full Details</a>
