    ...
    <div class="row">
        <div class="col-xl-4">
            ...
            <h4 class="card-header" align="center" >Details</h4>
                <div class="card-body text-center">
                    ...
                    <img class="img img-responsive"  width='400' height='250' src="{{ asset($tablet->image) }}" alt=""/>
        ...
        <div class="col-xl-8">
            ...
            <div class="card-body">
                ...
                <td>
                <a href ="{{ route('tablets.viewFolder',$tablet->id) }}" >{{ $tablet->purchaseOrder }} </a>    
                </td>
                </tr>
                ...
                <td>
                <a href ="{{ route('tablets.viewFolder',$tablet->id) }}">{{ $tablet->deliveryOrder }}</a>    
                </td>
                </tr>
                ...
                <td>
                <a href ="{{ route('tablets.viewFolder',$tablet->id) }}">{{ $tablet->invoiceNo }}</a>    
