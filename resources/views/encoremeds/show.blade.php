        ...
        <div class="col-xl-4">
            ...
            <h4 class="card-header" align="center" >Details</h4>
                <div class="card-body text-center">
                    ...
                    <img class="img img-responsive"  width='400' height='250' src="{{ asset($encoremed->image) }}" alt=""/>
        ...
        <div class="col-xl-8">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <div class="card-body">
                   <!--<div class="row">
                  <div class="bio-row">
                      <p><span>IP Address </span>: {{ $encoremed->deviceIPaddress }}</p>
                  </div>
                  <div class="bio-row">
                      <p><span>Manufacturer </span>: {{ $encoremed->deviceManufacturer }}</p>
                  </div>
                  
                  <div class="bio-row">
                      <p><span>Model </span>: {{ $encoremed->deviceModel }}</p>
                  </div>
                  <div class="bio-row">
                      <p><span>Warranty Date </span>: {{ $encoremed->warrantyDate }}</p>
                  </div>
                </div>
                </div>-->
            ...
            <div class="card-body">
                ...
                <td>
                <a href ="{{ route('encoremeds.viewFolder',$encoremed->id) }}" >{{ $encoremed->purchaseOrder }} </a>    
                </td>
                </tr>
                ...
                <td>
                <a href ="{{ route('encoremeds.viewFolder',$encoremed->id) }}">{{ $encoremed->deliveryOrder }}</a>    
                </td>
                </tr>
                ...
                <td>
                <a href ="{{ route('encoremeds.viewFolder',$encoremed->id) }}">{{ $encoremed->invoiceNo }}</a>    
