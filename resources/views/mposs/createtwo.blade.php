...
<form action="{{ route('mposs.storetwo') }}" method="POST">
    @csrf
                            <div class="form-group">
                                <label for="description">Device IP Address:</label>
                                <input type="text"  value="{{{ $mpos->deviceIPaddress ?? '' }}}" class="form-control"  name="deviceIPaddress"/>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="col-md-6 text-left">
                                <a href="{{ route('mposs.createone') }}" class="btn btn-danger pull-right">Previous</a>
                            </div>
