...
b, h6 {
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div>
                <a class="btn btn-success" href="{{ route('powers.create') }}"> Add New power</a>
            ...
            <form action="{{ url('importPower') }}" class="form-container" method="post" enctype="multipart/form-data">
                @csrf
    ...
    @if(count($powers))
       ...
       <tbody id="myTable">
        <tr >
            ...
            <td>
            <form action="{{ route('powers.destroy',$s->id) }}" method="POST">
   
                    <a class="btn btn-info" href="{{ route('powers.show',$s->id) }}">View Full Details</a>
    
                 
    
                    <a class="btn btn-primary" href="{{ route('powers.edit',$s->id) }}">Edit</a>
