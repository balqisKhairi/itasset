...
b, h6 {
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div>
                <a class="btn btn-success" href="{{ route('encoremeds.create') }}"> Add New encoremed</a>
            ...
            <form action="{{ url('importEncoremed') }}" class="form-container" method="post" enctype="multipart/form-data">
                @csrf
