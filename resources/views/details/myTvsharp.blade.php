...
b, h6 {
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div>
                <h2>List of tvsharps</h2>
            </div>
            <div>
                <a class="btn btn-success" href="{{ route('tvsharps.create') }}"> Add New tvsharp</a>
            ...
            <form action="{{ url('importTvsharp') }}" class="form-container" method="post" enctype="multipart/form-data">
                @csrf
