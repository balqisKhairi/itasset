...
input {
    ...
    border-width: 0;
    min-height: 40px;
    border: solid #98c1eb 2px !imposrtant;
}
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div>
                ...
                <a class="btn btn-success1"  onclick="openForm()">Imposrt from Excel</a>
                
               
         
           
            <div class="form-popup" id="myForm">
            <form action="{{ url('importMpos') }}" class="form-container" method="post" enctype="multipart/form-data">
                @csrf
       ...
       <tbody id="myTable">
        <tr >
            ...
            <form action="{{ route('mposs.destroy',$s->id) }}" method="POST">
                    ...
                    <a class="btn btn-primary" href="{{ route('mposs.edit',$s->id) }}">Edit</a>
