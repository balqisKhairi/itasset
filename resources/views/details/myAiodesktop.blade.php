...
b, h6 {
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div>
                <h2>List of aiodesktops</h2>
            </div>
            <div>
                <a class="btn btn-success" href="{{ route('aiodesktops.create') }}"> Add New aiodesktop</a>
            ...
            <form action="{{ url('importAiodesktop') }}" class="form-container" method="post" enctype="multipart/form-data">
                @csrf
       ...
       <tbody id="myTable">
        <tr >
            ...
            <form action="{{ route('aiodesktops.destroy',$s->id) }}" method="POST">
                    ...
                    <a class="btn btn-primary" href="{{ route('aiodesktops.edit',$s->id) }}">Edit</a>
