...
b, h6 {
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div>
                <a class="btn btn-success" href="{{ route('tablets.create') }}"> Add New tablet</a>
            ...
            <form action="{{ url('importTablet') }}" class="form-container" method="post" enctype="multipart/form-data">
                @csrf
            ...
            <a class="btn btn-primary" href="{{ route('tablets.exportTablet') }}"> Export to Excel</a>
    ...
    @if(count($tablets))
       ...
       <tbody id="myTable">
        <tr >
            ...
            <td>
            <form action="{{ route('tablets.destroy',$s->id) }}" method="POST">
   
                    <a class="btn btn-info" href="{{ route('tablets.show',$s->id) }}">View Full Details</a>
    
                 
    
                    <a class="btn btn-primary" href="{{ route('tablets.edit',$s->id) }}">Edit</a>
